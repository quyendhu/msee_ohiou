...
% M12-MATLAB
% 
% Exercise 11.1 on page 688 of the text lists the MATLAB code for a 
% simulation of binary polar signaling. This MS Word file
% module_12_computer_exercise_11-1.docx is a cut and paste of the 
% simulated code from the electronic version of the textbook. Your 
% assignment is to copy this text into a MATLAB.m file, get the code
% working, and reproduce the plots in figures 11.43, 11.44, and 11.45 
% of the text. Submit your final .m file code and the plots, and answer
% the following questions:
% 
%     1. Which pulse shape is the most bandwidth efficient?
%     2. Which pulse shape is the most energy efficient?
%     3. Why do you think that the simulated BER curves begin to deviate 
%     from theoretical at higher Eb/No values?



%  Matlab  Program  <Ex11_1.m>
%  This  Matlab  exercise  <Ex11_1.m>  performs  simulation  of
...
% hh = fdesign.pulseshaping(8,'Square Root Raised Cosine', 'N,Beta',6, 0.5);
